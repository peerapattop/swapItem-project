...
class _offerCome2State extends State<offerCome2> {
  ...
  //   return Scaffold(
  //     body: StreamBuilder(
  //       stream: _offerRef.orderByChild('uidUserpost').equalTo(_user.uid).onValue,
  //       builder: (context, snapshot) {
  //         if (snapshot.connectionState == ConnectionState.waiting) {
  //           return const Center(
  //             child: Column(
  ...
  //                 return offerCome2(postUid: post['post_uid'] ?? '');
  //               }).toList(),
  //             ),
  //           );
  //         } else {
  ...
  //     body: StreamBuilder(
  //       stream:
  //           _offerRef.orderByChild('uidUserpost').equalTo(_user.uid).onValue,
  //       builder: (context, snapshot) {
  //         if (snapshot.connectionState == ConnectionState.waiting) {
  //           return const Center(
  //             child: Column(
